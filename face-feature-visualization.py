...
# 内容图像 路径
content_img_path = './3m-zhang.JPEG'
...
content = tf.placeholder(tf.float32, shape = [1, 240, 240, 3])
...
with tf.Session() as sess:
    ...
    content_features = sess.run([content_features],feed_dict = {content:content_val})
